...
const AboutMe = () => {
  return (
    <m.div
      ...
      className='bg-black/20 backdrop-blur-lg pt-5 pb-5 md:pb-10 px-2 rounded-[28px] md:rounded-xl w-full max-w-3xl md:mt-72'>
      ...
      <div className='flex flex-col py-5 px-2 md:px-20 text-center justify-center items-center'>
        <p className='w-fulltext-gray-500 text-base md:text-xl drop-shadow-xl darktext-neutral-400'>
          ...
          lightning speeds and highly optimized applications. I am very
