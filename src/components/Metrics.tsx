...
export const RightMetrics = ({
  ...
  return (
    <m.div
      ...
      className='fixed hidden md:flex right-10 center-y 
     text-green-600 w-64 '>
      <Tilt className='bg-green-500/20 flex flex-col items-center gap-2 rounded-xl p-4'>
...
export const LeftMetrics = () => {
  return (
    <m.div
      ...
      w-72 '>
      <Tilt className='bg-green-500/20 rounded-xl flex p-4 gap-2 flex-col items-center  text-center text-green-600'>
        <h3 className=''>***</h3>
        <p className='text-sm'>
