...
const Maintext = () => {
  return (
    <div className='top-[350px] md:top-80 fixed'>
      <div
      ...
      before:dark:opacity-10 after:dark:from-green-900 after:dark:via-[#3cff01] after:dark:opacity-40 before:lg:h-[360px]">
        <h1
          className='text-base md:text-xl font-medium center-y whitespace-nowrap z-10 opacity-20 text-green-400
           flex gap-7 md:gap-44'>
          Web app <span className='text-green-200'>Mobile app</span>{" "}
          <span className='md:hidden text-white'>Backend</span>
